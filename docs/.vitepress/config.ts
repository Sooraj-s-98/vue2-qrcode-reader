...
if (process.env.VITEPRESS_BASE === undefined) {
  console.warn('env var VITEPRESS_BASE is undefined. Defaulting to: /vue2-qrcode-reader/')
}
const { VITEPRESS_BASE = '/vue2-qrcode-reader/' } = process.env
...
export default withPwa(
  defineConfig({
    ...
    themeConfig: {
      editLink: {
        pattern: 'https://github.com/sooraj-s-98/vue2-qrcode-reader/edit/main/docs/:path'
      },
      footer: {
      ...
      socialLinks: [{ icon: 'github', link: 'https://github.com/sooraj-s-98/vue2-qrcode-reader' }]
    },
